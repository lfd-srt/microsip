...
// ####
#pragma comment (lib, "pjsua-lib-i386-Win32-vc14-Release")
#pragma comment (lib, "pjsua2-lib-i386-Win32-vc14-Release")
		...
		if (pjsua_buddy_get_info(buddy_id, &buddy_info) == PJ_SUCCESS) {
			...
			if (contact) {
				...
				case PJSUA_BUDDY_STATUS_ONLINE:
					/*  #### - unknown PJRPID_ACTIVITY_ON_THE_PHONE constant 
